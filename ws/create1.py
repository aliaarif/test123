...
class GoogleMapScraper:
    ...
    def parse_business_address(self, business):
        try:
            btn = business.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[8]/div[9]/div/div/div[1]/div[2]/div/div[1]/div/div/div[1]/div[1]/div[3]/div/a')
            business.click()
    ...
    def parse_business_latitude_and_business_longitude(self, business):
        try:
            btn = business.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[8]/div[9]/div/div/div[1]/div[2]/div/div[1]/div/div/div[1]/div[1]/div[3]/div/a')
            business.click()
            self.driver.implicitly_wait(2)
            ...
            business_map_link = self.driver.current_url
            business_latitude = business_map_link
            business_longitude = business_map_link

            # print("Current URL:", business_latitude)
        except:
             business_latitude = ""
             business_longitude = ""
             
        return  business_latitude, business_longitude
    

    def parse_timing(self, business):
        try:
            btn = business.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[8]/div[9]/div/div/div[1]/div[2]/div/div[1]/div/div/div[1]/div[1]/div[3]/div/a')
            business.click()
            self.driver.implicitly_wait(2)

            # img = self.driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[8]/div[9]/div/div/div[1]/div[3]/div/div[1]/div/div/div[2]/div[7]/div[4]/div[1]/div[2]/div/span[2]')
            # img.click()
            # self.driver.implicitly_wait(2)

            business_timing_monday_start = self.driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div[8]/div[9]/div/div/div[1]/div[3]/div/div[1]/div/div/div[2]/div[7]/div[4]/div[2]/#area-label').get_attribute('area-label')
            print(business_timing_monday_start)
        except:
             business_timing_monday_start = ""
             
        return  business_timing_monday_start
    ...
    def get_business_info(self):
        ...
        for business in self.driver.find_elements(By.CLASS_NAME, 'THOPZb'):
            ...
            business_address = self.parse_business_address(business)
            ...
            business_latitude, business_longitude  = self.parse_business_latitude_and_business_longitude(business)
            # business_longitude = self.parse_business_address2(business)

            business_facebook = ''
            business_social_instagram = ''
            business_social_youtube = ''

            business_timing_monday_start = self.parse_timing(business)
            business_timing_monday_end = ''
            business_timing_tuesday_start = ''
            business_timing_tuesday_end = ''
            business_timing_wednesday_start = ''
            ...
            unique_id = "".join([business_phone, business_phone, business_website, business_rating, business_reviews_count, business_category])
            # unique_id = "".join([name])
...
urls = [
    ...
    "https://www.google.com/maps/search/football+acadmey+in+gurgaon",
    "https://www.google.com/maps/search/cricket+acadmey+in+gurgaon",
]
